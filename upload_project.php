    ...
    <form action="" method="post" style="margin-top: 92px;">
      <div class="container">
        <header class="section-header">
              <h3 class="section-title">detail about project</h3>
        </header>
        ...
        <div class="form-group row">
          ...
          <div class="col-10">
            <input class="form-control" type="password" value="hunter2" data-rule="required" id="password">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="file1" class="col-2 col-form-label">File input</label>
          <input type="file" class="form-control-file col-10" id="file1" aria-describedby="fileHelp" data-rule="required">
        </div>
        <div class="form-group row">
          <label for="file2" class="col-2 col-form-label">File input</label>
          <input type="file" class="form-control-file col-10" id="file2" aria-describedby="fileHelp">
        </div>
        <div class="form-group row">
          <label for="file3" class="col-2 col-form-label">File input</label>
          <input type="file" class="form-control-file col-10" id="file3" aria-describedby="fileHelp">
        </div>
        <div class="form-group row">
